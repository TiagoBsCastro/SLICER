/**
 * @file densitymaps.h
 * @brief This file defines the functions related to density map creation, particle mapping, and snapshot handling in the simulation environment.
 *
 * It includes functions for generating density maps, handling particle data, randomizing conditions in the simulation box, and utilities for working with comoving distances and snapshot data.
 */

#ifndef DENSITYMAPS_H
#define DENSITYMAPS_H
 ...
 * @return int The index of the snapshot closest to the specified comoving distance. Returns -1 if zsnap is empty.
 */
